package com.example.tpi.demo.config;
...
public class GWConfig {
    ...
    public ReactiveJwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        // Se especifica el nombre del claim a analizar README.md 2023-10-23 19 / 21
        grantedAuthoritiesConverter.setAuthoritiesClaimName("authorities");
        // Se agrega este prefijo en la conversión por una convención de Spring
        grantedAuthoritiesConverter.setAuthorityPrefix("ROLE_");
        // Se asocia el conversor de Authorities al Bean que convierte el tokenJWT a un objeto Authorization
